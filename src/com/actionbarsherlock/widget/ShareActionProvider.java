 ...
 * </p>
 * <p>
 * <strong>Note:</strong> While the sample snippet demonstrates how to use this
 * provider in the context of a menu item, the use of the provider is not
...
public class ShareActionProvider extends ActionProvider {
	...
	public interface OnShareTargetSelectedListener {
		 ...
		 * whether to handle the intent or rely on the default behavior which is
		 * launching it.
		 * <p>
		 * <strong>Note:</strong> Modifying the intent is not permitted and any
	 ...
	 * listener can optionally decide to handle the selection and not rely on
	 * the default behavior which is to launch the activity.
	 * <p>
	 * <strong>Note:</strong> If you choose the backing share history file you
	 * will still be notified in this callback.
	 * </p>
	 * 
	 * @param listener
	 *            The listener.
	 ...
	 * setting the file name will be backed by the provided file.
	 * <p>
	 * 
	...
	/**
	 * Set the activity chooser policy of the model backed by the current share
	...
	/**
	 * Policy that delegates to the {@link OnShareTargetSelectedListener}, if
	 * such.
	 */
