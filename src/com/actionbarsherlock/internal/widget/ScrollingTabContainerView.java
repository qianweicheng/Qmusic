 ...
 */
public class ScrollingTabContainerView extends NineHorizontalScrollView implements
	...
	public ScrollingTabContainerView(Context context) {
		...
		TypedArray a = getContext().obtainStyledAttributes(null, R.styleable.SherlockActionBar, R.attr.actionBarStyle,
				0);
	...
	private IcsLinearLayout createTabLayout() {
		final TabsLinearLayout tabLayout = (TabsLinearLayout) LayoutInflater.from(getContext()).inflate(
