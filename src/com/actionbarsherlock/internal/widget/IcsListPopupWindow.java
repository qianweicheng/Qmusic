...
public class IcsListPopupWindow {
	...
	public void show() {
		...
		if (mPopup.isShowing()) {
			...
			mPopup.update(mDropDownAnchorView, mDropDownHorizontalOffset, mDropDownVerticalOffset, widthSpec,
					heightSpec);
		} else {
			if (mDropDownWidth == ViewGroup.LayoutParams.MATCH_PARENT) {
	...
	private int buildDropDown() {
		...
		final int listContent = /* mDropDownList. */measureHeightOfChildren(MeasureSpec.UNSPECIFIED, 0, -1/*
																										 * ListView
																										 * .
																										 * NO_POSITION
																										 */, maxHeight
	...
	private int measureHeightOfChildren(int widthMeasureSpec, int startPosition, int endPosition, final int maxHeight,
	...
	private void measureScrapChild(View child, int position, int widthMeasureSpec) {
		...
		int childWidthSpec = ViewGroup.getChildMeasureSpec(widthMeasureSpec, mDropDownList.getPaddingLeft()
