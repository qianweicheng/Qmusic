...
public class SelectableRoundedImageView extends ImageView {
	...
	private static final ScaleType[] sScaleTypeArray = { ScaleType.MATRIX, ScaleType.FIT_XY, ScaleType.FIT_START, ScaleType.FIT_CENTER, ScaleType.FIT_END,
	...
	public SelectableRoundedImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mRadii = new float[] { mLeftTopCornerRadius, mLeftTopCornerRadius, mRightTopCornerRadius, mRightTopCornerRadius, mRightBottomCornerRadius,
		        mRightBottomCornerRadius, mLeftBottomCornerRadius, mLeftBottomCornerRadius };
	...
	static class SelectableRoundedCornerDrawable extends Drawable {
		...
		private void configureBounds(Canvas canvas) {
			...
			if (ScaleType.CENTER == mScaleType) {
				...
				mBounds.set(clipBounds);
			} else if (ScaleType.FIT_START == mScaleType || ScaleType.FIT_END == mScaleType || ScaleType.FIT_CENTER == mScaleType
		...
		private void adjustCanvasForBorder(Canvas canvas) {
			...
			if (ScaleType.FIT_START == mScaleType || ScaleType.FIT_END == mScaleType || ScaleType.FIT_XY == mScaleType || ScaleType.FIT_CENTER == mScaleType
