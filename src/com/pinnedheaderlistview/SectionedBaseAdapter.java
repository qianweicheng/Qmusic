...
import com.pinnedheaderlistview.PinnedHeaderListView.PinnedSectionedHeaderAdapter;
...
public abstract class SectionedBaseAdapter extends BaseAdapter implements
	...
	public final View getView(int position, View convertView, ViewGroup parent) {
		...
		return getItemView(getSectionForPosition(position),
				getPositionInSectionForPosition(position), position,
				convertView, parent);
	}
	...
	public abstract View getItemView(int section, int position,
			int rawPosition, View convertView, ViewGroup parent);
